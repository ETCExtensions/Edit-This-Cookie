var preferences_template = {
    ...
    "sortCookiesType": { //Supported: domain_alpha, alpha
...
//This way we limit the max amount of storage change events to one per second
...
function fetchData() {
    for (var key in preferences_template) {
        ...
        preferences.watch(key,
            ...
            //This one gets called upon reading a value
            function (id) {
